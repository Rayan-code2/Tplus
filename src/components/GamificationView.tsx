        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              Earn free spin credits every day or when you activate package upgrades and refer active direct nodes! All winnings go straight to your Winning Wallet with 10% withdrawal fee.
            </p>
